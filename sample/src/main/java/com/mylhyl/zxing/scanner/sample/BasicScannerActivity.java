...
public abstract class BasicScannerActivity extends AppCompatActivity implements
    ...
    public static final int REQUEST_CODE_SCANNER = 188;//请求编号
    public static final String EXTRA_RETURN_SCANNER_RESULT = "return_scanner_result";//返回扫描结果
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (extras != null) {
            mReturnScanResult = extras.getBoolean(EXTRA_RETURN_SCANNER_RESULT);//是否返回结果
        }
    }
