...
public class ScannerActivity extends DeCodeActivity {
    ...
    public static final String EXTRA_LASER_LINE_MODE = "extra_laser_line_mode";//扫描线类型 线型，网格
    public static final String EXTRA_SCAN_MODE = "extra_scan_mode"; //扫描类型
    public static final String EXTRA_SHOW_THUMBNAIL = "EXTRA_SHOW_THUMBNAIL";//显示略缩图
    public static final String EXTRA_SCAN_FULL_SCREEN = "EXTRA_SCAN_FULL_SCREEN";//全屏扫描
    public static final String EXTRA_HIDE_LASER_FRAME = "EXTRA_HIDE_LASER_FRAME";//扫描框 默认

    public static final int EXTRA_LASER_LINE_MODE_0 = 0;//线条图
    public static final int EXTRA_LASER_LINE_MODE_1 = 1;//网格
    public static final int EXTRA_LASER_LINE_MODE_2 = 2;//线

    public static final int EXTRA_SCAN_MODE_0 = 0;//全部
    public static final int EXTRA_SCAN_MODE_1 = 1;//二维码
    public static final int EXTRA_SCAN_MODE_2 = 2;//一维码
